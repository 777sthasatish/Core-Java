 ...
 * @author Satish
 */
public class ViewDonorRegister extends javax.swing.JFrame {
    ...
    public ViewDonorRegister() {
        initComponents();
        loadDonorRegister();
        setTitle("View Registered Donor");
    }
    ...
    private void initComponents() {
        ...
        donorRegisterTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Gender", "Age", "Weight", "Home Address", "Official Address", "Phone Number", "Office Number", "Mobile Number", "E-Mail", "Blood Group"
            }
        ));
...
private void loadDonorRegister() {
        try {
           DonorService donorService=new DonorService();
            List<Donor> donorRegister = donorService.getListOfDonors();
            DefaultTableModel dtm = (DefaultTableModel) donorRegisterTable.getModel();
            dtm.setRowCount(0);
            for (Donor record : donorRegister) {
                

                    Object[] rowDataObjects = {record.getName(), record.getGender(), record.getAge(), record.getWeight(), record.getHomeAddr(), record.getOffAddr(), record.getPhNo(), record.getOffNo(), record.getMoNo(), record.geteMail(), record.getBloodGrp()};
...
public void resizeColumnWidth(JTable table) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewDonorRegister.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewDonorRegister().setVisible(true);
            }
        });
    }
