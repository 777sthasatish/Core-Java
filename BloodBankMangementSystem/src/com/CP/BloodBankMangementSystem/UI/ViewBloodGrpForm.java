 ...
 * @author Satish
 */
public class ViewBloodGrpForm extends javax.swing.JFrame {

    /**
     * Creates new form ViewBloodGrpForm
     */
    public ViewBloodGrpForm() {
        initComponents();
        loadDonorBloodRegister();
        setTitle("View Blood Group Details");
    }
    ...
    private void initComponents() {
        ...
        donorRegisterTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Blood Group", "Blood Packet", "Date"
            }
        ));
    ...
    private void loadDonorBloodRegister() {
        try {
           DonorBloodService donorBloodService=new DonorBloodService();
            List<DonorBlood> donorBloodRegister = donorBloodService.getListOfDonorBlood();
            DefaultTableModel dtm = (DefaultTableModel) donorRegisterTable.getModel();
            dtm.setRowCount(0);
            for (DonorBlood record : donorBloodRegister) {
                

                    Object[] rowDataObjects = {record.getDonorName(), record.getBloodGrp(), record.getBloodPacket(), record.getDonotedDate()};
...
public void resizeColumnWidth(JTable table) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewBloodGrpForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewBloodGrpForm().setVisible(true);
            }
        });
    }
